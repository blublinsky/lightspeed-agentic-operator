...
- **Tool-result inspection failure [PLANNED: OLS-3928]:** `pod_handler.go` maps the controlled sandbox termination reason to the same step condition reason. The condition message uses the fixed safe text and excludes tool content.
