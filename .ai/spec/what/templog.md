...
18. The finalizer depends on the Collector admin API being reachable. If the Collector is permanently down, the finalizer gives up after 3 retries to avoid blocking CR deletion indefinitely.
