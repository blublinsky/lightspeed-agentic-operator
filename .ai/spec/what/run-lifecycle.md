...
- `spec.terminalTTL` (positive whole days), `status.terminalTime`, `status.deleteAfter` [PLANNED: OLS-4280] (terminal-run auto-deletion, rules 23–24)
